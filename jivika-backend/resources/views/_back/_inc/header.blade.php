        ...
        <ul class="navbar-nav flex-row align-items-center ms-auto">
            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                        <a class="dropdown-item @if(str_contains(Request::url() ,'admin/profile')) active @endif" href="{{url('admin/profile')}}">
                            <i class="ti ti-user-check me-2 ti-sm"></i>
                            <span class="align-middle">My Profile</span>
                        </a>
                    </li>
                    <li>
                        <a class="dropdown-item @if(str_contains(Request::url() ,'admin/changepassword')) active @endif" href="{{url('admin/changepassword')}}">
